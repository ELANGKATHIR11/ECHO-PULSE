...
XTF_RPY_RAD = False
XTF_UTC_TIME = 0
XTF_INTENSITY_BITS = 12

############ Image filtering parameters ##############

MIN_IMAGE_HEIGHT = 1.0
MAX_IMAGE_HEIGHT = 4.0
...
PROCESS_FOLDER_PATH = "output/processed"
DATASET_FOLDER_PATH = "output/dataset"
...
def printParameters():
    ...
    print(f"Minimum vehicle height for camera images: {MIN_IMAGE_HEIGHT} [metres]")
    ...
    print(f"\tRoll, pitch, yaw in radians: {'Yes' if XTF_RPY_RAD else 'No'}")
...
def saveParameters():
    ...
    if EXTRACT_IMAGES or EXTRACT_NAVIGATION or EXTRACT_PATCHES:
        ...
        print("Parameters saved to processing folder on disk!") 
    ...
    if BUILD_DATASET:
        ...
        print("Parameters saved to dataset folder on disk!")  
